  ...
  public void show(int timeout) {
    if (!mShowing && mAnchor != null && mAnchor.getWindowToken() != null) {
      ...
      if (mFromXml) {
        ...
        int heightDP = 70; //this
        int heightPixel = (int) convertDpToPixel(heightDP,mContext);

        mWindow.showAtLocation(mAnchor, Gravity.NO_GRAVITY, anchorRect.left, anchorRect.bottom - heightPixel);
      }
      mShowing = true;
